...
from uvec_two_dof_vehicle_2D.uvec import uvec, uvec_static
...
class TestTwoDofNoContact(unittest.TestCase):
    ...
    def test_static_two_dof_model(self):
        ...
        for t in range(n_steps - 1):
            ...
            all_u_bogie.append(json_input_data["state"]["u"][0])
        ...
        expected_beam_deflection = ((json_input_data["parameters"]["m2"] +
                                     json_input_data["parameters"][
        ...
        expected_diff_displacement_vehicle = (json_input_data["parameters"]["m1"] * gravity_constant /
                                              json_input_data["parameters"]["k"])
