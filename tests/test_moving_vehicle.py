...
from UVEC.uvec_ten_dof_vehicle_2D_hertz.newmark_solver import NewmarkExplicit, StaticSolver
...
class TestSpringDamperModel():
    ...
    def test_spring_hinge_irregularity(self):
        ...
        # load expected results
        expected_results = json.load(open('tests/test_data/expected_data_test_joint.json', "r"))
    ...
    def test_spring_hinge_irregularity_static(self):
        ...
        # load expected results
        expected_results = json.load(open('tests/test_data/expected_data_test_joint_static.json', "r"))
